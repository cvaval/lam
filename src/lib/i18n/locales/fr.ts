...
export const fr = {
  ...
  tarifs: {
    ...
    leviesSub: 'Droits et taxes perçus à l’importation, distincts du droit de douane (s’ajoutent à la liquidation).',
    thLevy: 'Prélèvement',
    thRate: 'Taux / montant',
    thBase: 'Base',
    thRef: 'Référence',
    ...
    quantity: 'Quantité',
    calcAcompte: 'Acompte d’impôt sur le revenu (2 %)',
    calcBordereau: 'Droit de bordereau (1 %)',
    calcTotal: 'Total estimé (droits et taxes)',
    calcGrand: 'Coût de revient estimé (CIF + droits et taxes)',
    calcDisclaimer: 'Estimation indicative — base des accises et de la TCA : valeur CIF majorée du droit de douane. Hors conteneur, taxe environnementale et frais portuaires ; à confirmer auprès de l’AGD / DGI.',
    calcSituational: 'Non inclus (situationnels) : droit de conteneur (40 USD maritime / 5 000 HTG terrestre), taxe environnementale (pneus/batteries 10 %, véhicules 25 %).',
    close: 'Fermer',
