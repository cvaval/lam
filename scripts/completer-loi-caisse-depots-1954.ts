 ...
 * déposant ou la partie à qui des offres ont été faites… » est imprimé DEUX FOIS : une
 * première avec « Il sera inscrit au jour le jour… » couru à la suite, une seconde s'arrêtant
 * à « …sur lesdits objets, valeurs ou titres », suivie du même « Il sera inscrit… » en alinéa
 * autonome. La première n'est pas une variante : elle fait 669 caractères, soit EXACTEMENT
 * les 462 de la seconde plus les 206 de l'alinéa suivant et l'espace qui les joint. C'est
 * l'accident du compositeur, et non une rédaction. On garde la version scindée, conforme à
 * la mise en page du reste de la loi ; pas un mot n'est perdu.
 *
